...
class PongGame {
    constructor(canvas, playerId) {
        ...
        this.ballImage.src = "C:\Users\ahmed\Downloads\soccer ball.png"
        this.ballImage.height=20
        this.ballImage.width=20
    ...
    draw() {
        ...
        if (this.players.length === 2) {
            this.ctx.fillText("Score: " + (this.scores[players[0]] || 0), CANVAS_WIDTH / 4, 30)
            this.ctx.fillText("Score: " + (this.scores[players[1]] || 0), (CANVAS_WIDTH / 4) * 3, 30)
        }
    }
